...
Kolyx is a delivery marketplace designed to reduce shipping costs by connecting people who need to send packages with travelers who are already flying to the destination. Instead of relying exclusively on traditional courier services, users can pay a traveler to transport their package during a trip they were already planning, creating a more affordable and flexible delivery alternative.

This project was developed as a freelance software engineering engagement for an independent startup. The application is currently being built as a Minimum Viable Product (MVP) to validate the client's business model before investing in a larger-scale production platform.
